...
Decred Webwallet is a secure [Decred](https://www.decred.org) wallet platform for both desktop and mobile devices. It is based on the [Webwallet](https://copay.io) and uses [Bitcore Wallet Service](https://github.com/decred/bitcore-wallet-service) (BWS) for peer synchronization and network interfacing.
...
It is possible to recover funds from a Webwallet Wallet without using Webwallet or the Wallet Service, check the [Webwallet Recovery Tool](https://github.com/bitpay/copay-recovery).
...
Webwallet depends on [Bitcore Wallet Service](https://github.com/bitpay/bitcore-wallet-service) (BWS) for blockchain information, networking and Copayer synchronization.  A BWS instance can be setup and operational within minutes or you can use a public instance like `https://bws.bitpay.com`.  Switching between BWS instances is very simple and can be done with a click from within Webwallet.  BWS also allows Webwallet to interoperate with other wallets like [Bitcore Wallet CLI] (https://github.com/bitpay/bitcore-wallet).
...
Finally, in case you lose the device and you have the 24 word seed for the device, you can recover access to your funds using Webwallet, see: https://github.com/bitpay/copay/blob/master/backupRecovery.md#hardware-wallets
...
Webwallet is released under the MIT License.  Please refer to the [LICENSE](https://github.com/bitpay/copay/blob/master/LICENSE) file that accompanies this project for more information including complete terms and conditions.
